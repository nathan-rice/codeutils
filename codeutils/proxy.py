...
class Constraints(ABCMeta):
    ...
    def __instancecheck__(self, other):
        ...
        return all(arg.evaluate(other) for arg in self.args)
...
class Is(Constraint):
    ...
    def evaluate(self, other):
        return isinstance(other, self.target)
...
class Matches(Constraint):
    ...
    def __init__(self, other):
        self.target = re.compile(other)

    def evaluate(self, other):
        return self.target.match(other)

class Members(Constraint):
    pass
